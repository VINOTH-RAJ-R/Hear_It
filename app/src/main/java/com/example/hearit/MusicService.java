...
import static com.example.hearit.ApplicationClass.CHANNEL_ID_2;
import static com.example.hearit.PlayerActivity.listSongs;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    void createMediaPlayer(int positionInner){
        ...
        editor.putString (ARTIST_NAME,musicFiles.get(position).getTitle ());
